...
module axi_intercon
  ...
  localparam rule_t [2:0] AddrMap = '{
	...
	'{idx: 32'd2, start_addr: 32'h80100000, end_addr: 32'h80200000}};
   ...
   //Slave user
   assign o_user_awid = slaves_req[2].aw.id;
   assign o_user_awaddr = slaves_req[2].aw.addr;
   assign o_user_awlen = slaves_req[2].aw.len;
   assign o_user_awsize = slaves_req[2].aw.size;
   assign o_user_awburst = slaves_req[2].aw.burst;
   assign o_user_awlock = slaves_req[2].aw.lock;
   assign o_user_awcache = slaves_req[2].aw.cache;
   assign o_user_awprot = slaves_req[2].aw.prot;
   assign o_user_awregion = slaves_req[2].aw.region;
   assign o_user_awqos = slaves_req[2].aw.qos;
   assign o_user_awvalid = slaves_req[2].aw_valid;
   assign slaves_resp[2].aw_ready = i_user_awready;
   assign o_user_arid = slaves_req[2].ar.id;
   assign o_user_araddr = slaves_req[2].ar.addr;
   assign o_user_arlen = slaves_req[2].ar.len;
   assign o_user_arsize = slaves_req[2].ar.size;
   assign o_user_arburst = slaves_req[2].ar.burst;
   assign o_user_arlock = slaves_req[2].ar.lock;
   assign o_user_arcache = slaves_req[2].ar.cache;
   assign o_user_arprot = slaves_req[2].ar.prot;
   assign o_user_arregion = slaves_req[2].ar.region;
   assign o_user_arqos = slaves_req[2].ar.qos;
   assign o_user_arvalid = slaves_req[2].ar_valid;
   assign slaves_resp[2].ar_ready = i_user_arready;
   assign o_user_wdata = slaves_req[2].w.data;
   assign o_user_wstrb = slaves_req[2].w.strb;
   assign o_user_wlast = slaves_req[2].w.last;
   assign o_user_wvalid = slaves_req[2].w_valid;
   assign slaves_resp[2].w_ready = i_user_wready;
   assign slaves_resp[2].b.id    = i_user_bid;
   assign slaves_resp[2].b.resp  = i_user_bresp;
   assign slaves_resp[2].b_valid = i_user_bvalid;
   assign o_user_bready = slaves_req[2].b_ready;
   assign slaves_resp[2].r.id    = i_user_rid;
   assign slaves_resp[2].r.data  = i_user_rdata;
   assign slaves_resp[2].r.resp  = i_user_rresp;
   assign slaves_resp[2].r.last  = i_user_rlast;
   assign slaves_resp[2].r_valid = i_user_rvalid;
   assign o_user_rready = slaves_req[2].r_ready;
